...
[<a href="<c:url context="/" value="/edit-boxes.jsp"/>">В&nbsp;начало</a>] [<a href="<c:url context="/" value="/edit-profile.jsp"/>">Настройки&nbsp;профиля</a>] [<a href="<c:url context="/" value="/"/>">На&nbsp;главную&nbsp;страницу</a>]
<br/>
